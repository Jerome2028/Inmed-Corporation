...
<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top shadow-sm">
    <div class ="container d-flex justify-content-center">
        <div class ="row">
            <div class="col-sm-2">
                <a class="navbar-brand" href="<?= $ADBASE; ?>"><img src = "<?= $ADBASE ?>assets/img/Inmed-01.svg" class ="inmed-nav w-75"></a>
            </div>
                ...
                <div class="navbar-collapse mt-2" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        <li class="nav-item active">
                            <a class="nav-link" href="<?= $ADBASE ?>">Home</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?= $ADBASE ?>about-us/">About Us</a>
                        </li>
                        <li class="nav-item">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="link"><a class="dropdown-item" href="<?= $ADBASE ?>brochures&catalog/">Brochures & Catalog</a></li>
                                    <li class="link"><a class="dropdown-item" href="<?= $ADBASE ?>manual">Manual</a></li>
                                </ul>
                                </div>
                        </li>
                        <!-- <li class="nav-item">
                            <a class="nav-link" href="<?= $ADBASE ?>resources/">Resources</a>
                        </li> -->
                        <li class="nav-item">
                            <a class="nav-link" href="<?= $ADBASE ?>career">Careers</a>
                        </li> 
                        <li class="nav-item">
...
<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
          ...
          <ul class="navbar-nav">
            <li class="nav-item active start">
                <a class="nav-link" href="<?= $ADBASE ?>">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= $ADBASE ?>about-us/">About Us</a>
            </li>
...
<script src="<?= $ADBASE ?>assets/js/search.js"></script>
